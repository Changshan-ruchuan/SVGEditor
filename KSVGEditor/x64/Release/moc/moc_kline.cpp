/****************************************************************************
** Meta object code from reading C++ file 'kline.h'
**
...
#error "The header file 'kline.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject KLine::staticMetaObject = { {
    QMetaObject::SuperData::link<KShape::staticMetaObject>(),
    qt_meta_stringdata_KLine.data,
    qt_meta_data_KLine,
    qt_static_metacall,
    nullptr,
    nullptr
